    ...
    <>
      ...
      <div className="aboutContainer">
        <div className="about">
          ...
          >
            <Card.Body>
              {/* <h3 style={{ marginTop:'19px',marginLeft:'', color:'#910A67' }}><b>LIBRARY ADVISORY COMMITTEE:</b></h3> */}
              <p style={{ color: "green" }}>
                Specified collections are availablein Engineering and Technology
              </p>
              <Card.Text>
                <div className="Column2">
                  <table>
                    ...
                    <tr>
                      <td>3</td>
                      <td>Journels & Magazines(Print)</td>
                      <td>142</td>
                    </tr>
